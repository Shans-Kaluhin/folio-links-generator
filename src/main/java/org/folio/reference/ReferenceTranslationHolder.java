...
public enum ReferenceTranslationHolder implements TranslationHolder, TranslationFunction {
  SET_VALUE {
    public String apply(String value, int currentIndex, Translation translation, ReferenceDataWrapper referenceData,
                        Metadata metadata) {
      return translation.getParameter("value");
    }
  },
  SET_NATURE_OF_CONTENT_TERM {
    public String apply(String id, int currentIndex, Translation translation, ReferenceDataWrapper referenceData,
                        Metadata metadata) {
      return "audiobook";
    }
  },
